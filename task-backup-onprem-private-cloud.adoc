...
.Étapes
. Dans Canvas, sélectionnez l'environnement de travail sur site et cliquez sur *Activer > volumes de sauvegarde* en regard du service sauvegarde et restauration dans le panneau de droite.
+
