...
[role="quick-margin-para"]
Sélectionnez l'environnement de travail et cliquez sur *Activer > Backup volumes* en regard du service Backup & Restore dans le panneau droit. Suivez ensuite l'assistant d'installation pour définir la stratégie de sauvegarde par défaut et le nombre de sauvegardes à conserver, puis sélectionnez les volumes à sauvegarder.
